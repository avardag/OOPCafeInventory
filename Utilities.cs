using OOPCafeInventory;
using OOPCafeInventory.Domain.General;
using OOPCafeInventory.Domain.OrderManagement;
...
internal class Utilities
{
    ...
    private static void ShowAddNewOrder()
    {
        ...
        do
        {
            ...
            Console.WriteLine(
                "Which product do you want to order? (enter 0 to stop adding new products to the order)"
            );
    ...
    {
        Console.WriteLine(
            $"Enter the new stock treshold (current value: {Product.StockThreshold}). This applies to all products!"
        );
